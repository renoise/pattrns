...
// Unused pattrns phrase API function impls:
//
// Those functions will be loaded, but are not called/used in Renoise
// and will be removed or replaced in the next API update.

#[repr(C)]
/// cbindgen:ignore
pub struct PhrasePlaybackEvent {}
...
#[no_mangle]
/// cbindgen:ignore
pub unsafe extern "C" fn new_phrase(
    _time_base: Timebase,
    _patterns_ptr: *const *const Pattern,
    _patterns_len: u32,
) -> PhraseResult {
    panic!(
        "pattrns function: '{}' is deprecated and undefined.",
        "new_phrase"
    );
}
...
#[no_mangle]
/// cbindgen:ignore
pub unsafe extern "C" fn set_phrase_time_base(
    _this: *mut Phrase,
    _time_base: Timebase,
) -> VoidResult {
    panic!(
        "pattrns function: '{}' is deprecated and undefined.",
        "set_phrase_time_base"
    );
}

#[no_mangle]
/// cbindgen:ignore
pub unsafe extern "C" fn run_phrase(
    _this: *mut Phrase,
    _callback_context: *mut c_void,
    _callback: extern "C" fn(*mut c_void, &PhrasePlaybackEvent),
) -> VoidResult {
    panic!(
        "pattrns function: '{}' is deprecated and undefined.",
        "run_phrase"
...
#[no_mangle]
/// cbindgen:ignore
pub unsafe extern "C" fn run_phrase_until_time(
    _this: *mut Phrase,
    _time: u64,
    _callback_context: *mut c_void,
    _callback: extern "C" fn(*mut c_void, &PhrasePlaybackEvent),
    ...
    panic!(
        "pattrns function: '{}' is deprecated and undefined.",
        "run_phrase_until_time"
    );
}

#[no_mangle]
/// cbindgen:ignore
pub unsafe extern "C" fn advance_phrase_until_time(_this: *mut Phrase, _time: u64) -> VoidResult {
    panic!(
        "pattrns function: '{}' is deprecated and undefined.",
        "advance_phrase_until_time"
    );
}

#[no_mangle]
/// cbindgen:ignore
pub unsafe extern "C" fn drop_phrase(_phrase: *mut Phrase) {
    panic!(
        "pattrns function: '{}' is deprecated and undefined.",
        "drop_phrase"
    );
